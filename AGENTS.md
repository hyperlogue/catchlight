...
| `@catchlight/core` | UI-framework-agnostic: transport, storage, sessions. Web-platform glue only — anything a native editor would also need belongs in Rust. |
...
editor compiling for wasm32, the editor server included.
